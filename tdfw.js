...
(function () {
  ...
  function setupAnimations() {
    ...
    var introKeyFrameDef =
      "@-webkit-keyframes tdfwIntro { " + introKeyFrames + " } ";
    ...
    var introClass =
      ".tdfw_intro { -webkit-animation: tdfw 1s infinite; animation: tdfw 1s infinite; } ";
    ...
    nodes = nodes.concat(
      Array.prototype.slice.call(
        document.querySelectorAll(
          "section, header, footer, video, iframe, nav, article, h1, h2, h3, h4, h5, h6, footer, main, p, pre, blockquote, ol, ul, li, embed, object, canvas, svg, form, input, select, button"
        )
      )
    );
